...
- Aim to understand the extension of depth concepts to non-Euclidean settings, evaluate their practical performance on simulated and real data, and build a tool that visualizes the depths of different object data.
...
- *Supervisor: Justin Holmer (Brown University)*
